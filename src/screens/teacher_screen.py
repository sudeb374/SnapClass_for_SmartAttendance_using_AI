...
from src.database.db import check_teacher_exits, create_teacher,teacher_login, get_teacher_subjects
...
def teacher_tab_manage_subjects():
    ...
    with col1:
        st.subheader('Manage Subjects', width='stretch')

    with col2:
        if st.button('Create_new_subjects', width = 'stretch', icon = ':material/add_box:'):
